...
def main():
    ...
    # os.environ["CUDA_VISIBLE_DEVICES"] = "-1"  # Disable CUDA for the current session
    ...
    token_embeddings = text_to_token_embeddings(model, tokenizer, combined_text, batch_size=512, skip_beginning=0, skip_end=0)
