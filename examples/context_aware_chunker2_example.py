...
chunker = ContextAwareChunker(
    ...
    context_group_token_limit=4000,            # Each context group can have up to 250 tokens
    context_group_overlap_size=100,             # Each subsequent group overlaps the previous by 50 tokens
    pooling_method="mean",
